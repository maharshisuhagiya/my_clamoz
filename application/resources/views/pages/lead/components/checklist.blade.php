...
<div class="checklist-item clearfix" id="lead_checklist_container_{{ $checklist->checklist_id }}" data-id="{{ $checklist->checklist_id }}">
    <!--drag icon-->
    <span class="mdi mdi-drag-vertical cursor-pointer drag-handle position-absolute left-3 top-4 hidden"></span>
    <!--checkbox-->
    <input type="checkbox" class="filled-in chk-col-light-blue js-ajax-ux-request-default" name="card_checklist[{{ $checklist->checklist_id }}]"
   ...
   @endif
    ...
    <div class="checklist-comments-wrapper" id="checklist-comments-wrapper-{{ $checklist->checklist_id }}">
        ...
        <div class="checklist-comments-textarea-wrapper hidden"
            ...
            <div class="text-right">
                ...
                <button type="button" class="btn btn-danger btn-xs x-submit-button checklist-comments-submit-button ajax-request"
                    data-url="{{ url('/leads/'.$checklist->checklistresource_id.'/post-checklist-comment') }}"
        ...
        <div class="checklist-comments-list-wrapper hidden"
            ...
            @include('pages.lead.components.checklist-comment')
            @endforeach
            @endif
        </div>
    </div>
