    ...
    <td class="timesheets_col_action actions_column">
        <span class="list-table-action dropdown  font-size-inherit">
            ...
            <button type="button" title="{{ cleanLang(__('lang.edit')) }}"
                ...
                data-url="{{ urlResource('/timesheets/'.$timesheet->timer_id.'/edit') }}"
                data-loading-target="commonModalBody" data-modal-title="{{ cleanLang(__('lang.edit_timesheet')) }}"
            ...
            @endif
            @if($timesheet->timer_billing_status == 'invoiced')
            <a href="{{ url('/invoices/'.$timesheet->timer_billing_invoiceid) }}"
