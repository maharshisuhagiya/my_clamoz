...
<div class="card shadow-sm">
    <div class="card-body">
        ...
        <h4 class="mb-2">Address Of Living In Tax Year</h4>
        ...
        <div class="text-center mt-4">
            <button type="submit" class="btn btn-success px-4" id="addressSubmitBtn">Submit</button>
            <button id="add-more" type="button" class="btn btn-primary px-4">+ Add More</button>
        </div>
