...
class Comments extends Controller {
    ...
    public function index() {
        ...
        //mark comment as client read for this feed
        if (request()->filled('commentresource_type') && request()->filled('commentresource_id')) {
            \App\Models\Comment::where('commentresource_type', request('commentresource_type'))
                ->where('commentresource_id', request('commentresource_id'))
