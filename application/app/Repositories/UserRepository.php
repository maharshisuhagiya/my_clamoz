...
class UserRepository {
    ...
    public function updatePreferences($id = '') {
        ...
        if ($user = $this->users->find($id)) {
            ...
            //preference: shide completed tasks
            if (in_array(request('pref_hide_completed_tasks'), array('yes', 'no'))) {
                $user->pref_hide_completed_tasks = request('pref_hide_completed_tasks');
            }

            //preference: show archived tasks
            if (in_array(request('pref_filter_show_archived_tasks'), array('yes', 'no'))) {
                $user->pref_filter_show_archived_tasks = request('pref_filter_show_archived_tasks');
            }
            ...
            //preference: show filter projects or all
            ...
            //preference: show filter tickets or all
            if (in_array(request('pref_filter_show_archived_tickets'), array('yes', 'no'))) {
                $user->pref_filter_show_archived_tickets = request('pref_filter_show_archived_tickets');
            }
